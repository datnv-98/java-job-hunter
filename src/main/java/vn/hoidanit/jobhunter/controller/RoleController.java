...
public class RoleController {
    ...
    public ResponseEntity<Role> create(@Valid @RequestBody Role r) throws IdInvalidException {
        ...
        if (this.roleService.existByName(r.getName())) {
            throw new IdInvalidException("Role với name = " + r.getName() + " đã tồn tại");
        }
    ...
    public ResponseEntity<Role> update(@Valid @RequestBody Role r) throws IdInvalidException {
        ...
        if (this.roleService.fetchById(r.getId()) == null) {
            throw new IdInvalidException("Role với id = " + r.getId() + " không tồn tại");
        }

        // check name
        // if (this.roleService.existByName(r.getName())) {
        // throw new IdInvalidException("Role với name = " + r.getName() + " đã tồn
        // tại");
        // }
    ...
    public ResponseEntity<Void> delete(@PathVariable("id") long id) throws IdInvalidException {
        ...
        if (this.roleService.fetchById(id) == null) {
            throw new IdInvalidException("Role với id = " + id + " không tồn tại");
        }
    ...
    public ResponseEntity<ResPaginationDTO> getRoles(@Filter Specification<Role> spec, Pageable pageable) {
    ...
    public ResponseEntity<Role> getById(@PathVariable("id") long id) throws IdInvalidException {
        ...
        if (role == null) {
            throw new IdInvalidException("Resume với id = " + id + " không tồn tại");
        }
